...
namespace MediPlus.Controllers
{
    public class SecretariumsController : Controller
    {
        ...
        {
            ViewData["IdDoctor"] = new SelectList(_context.Medicos, "Id", "Oficina");
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellidos,Oficina,Telefono,IdUsuario,IdDoctor")] Secretarium secretarium)
        {
            ...
            ViewData["IdDoctor"] = new SelectList(_context.Medicos, "Id", "Oficina", secretarium.IdDoctor);
            ViewData["IdUsuario"] = new SelectList(_context.Usuarios, "Id", "Clave", secretarium.IdUsuario);
            return View(secretarium);
        }
